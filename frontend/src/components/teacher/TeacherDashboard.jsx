...
const TeacherDashboard = () => {
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.4)), url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQpWAZEqSP6I6o8qvdL711iPvaP5QC2YKCLLIYjjvcfZzcCLDOlX0R2v5T5&s=10') center / cover no-repeat`,
      }}
    >
      <div className="dashboard-content">
        <div className="dashboard-welcome">
          ...
          <p className="welcome-text">Blessed Teaching · Guide your students with wisdom</p>
        </div>
